...
placeholders — always pull actual colors from the project's `color-palette.yml` based on the element's semantic
purpose.
...
For multi-point arrows (L-shape, U-turn), add intermediate points to the `points` array. See `arrows.md` for
routing patterns.
